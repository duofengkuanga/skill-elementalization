...
This project is indexed by GitNexus as **skill-elementalization** (1059 symbols, 2762 relationships, 93 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
