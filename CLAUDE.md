...
This project is indexed by GitNexus as **skill-elementalization** (1035 symbols, 2726 relationships, 91 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
